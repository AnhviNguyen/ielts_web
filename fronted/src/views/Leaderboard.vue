          ...
          <div class="spotify-panel__header text-center" data-tour="page-header">
            ...
            <div class="mt-4 flex flex-wrap justify-center gap-2">
              <button
                ...
                :key="p.id"
                type="button"
                class="rounded-full border px-3 py-1.5 text-[12px] font-semibold transition-[background,border-color,color] duration-200 ease-in-out"
                :class="period === p.id
                  ? 'border-[var(--spotify-green)] bg-[var(--spotify-green)] text-black'
                  : 'border-[var(--border-button)] bg-[var(--bg-interactive)] text-[var(--ink2)] hover:border-[var(--spotify-green)] hover:text-[var(--ink)]'"
      ...
      >
        <div class="lb-rank">
          <span
            class="lb-rank-num"
            :class="{
              'text-[var(--amber)]': entry.rank === 1,
              'text-[var(--ink3)]': entry.rank === 2,
              'text-[var(--gold)]': entry.rank === 3,
            }"
          >{{ entry.rank }}</span>
        </div>
        ...
        <div class="lb-info">
          ...
          <div class="lb-streak">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="var(--amber)" stroke-width="2"><path d="M12 2c0 0-5 6-5 10a5 5 0 0 0 10 0c0-4-5-10-5-10z"/></svg>
